...
private lateinit var binding: ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setup data table
        val dataHelper =  ContactListTable(this.applicationContext, null)

        // wipe user saved preferences
        val prefs : PreferenceHelper = PreferenceHelper(this)
        prefs.clearSharedPreference()

        // setup initial drawer and navigation
